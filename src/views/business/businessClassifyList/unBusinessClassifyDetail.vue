<template>
  <div class="goodsBrandsDetail">
    <el-form ref="form" :model="form" label-width="120px" :rules='rules'>
      ...
      <el-form-item prop='iconPath' v-if='level == 2'>
        <el-upload
...
//        })
      ...
      if (this.$route.query.id) {
        this.$axios({
          type: 'get',
          url: '/bhs-management-admin/category/' + this.$route.query.id,
          data: {},
          fuc: (res) => {
    ...
    methods: {
        ...
        this.$refs['form'].validate((valid) => {
          if (valid) {
            ...
            this.$axios({
              ...
              url: '/bhs-management-admin/category',
              data: _form,
              fuc: (res) => {
                if (res.code == 1) {
                  this.$message.success('操作成功')
                  this.level == 1 ? this.$deleteOneTag('/business/unlineBusinessClassifyList') : this.$deleteOneTag('/business/unBusinessClassifySecondList', {pid: this.form.pid})
                }
      ...
      beforeAvatarUploadLogo (file) {
        ...
        formData.append('folder', "category/manage")
        this.$axios({
          type: 'post',
